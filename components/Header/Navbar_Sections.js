  ...
  switch(props.megaMenu){
    case 'megaMenu1': 
      return (
        ...
        <div id="megaMenu1" className="container-fluid MegaMenu MegaMenu-top-one">
    ...
    case 'megaMenu4': 
      return (
        <>
        <div id="windowCloseClick" className="windowCloseClick" onClick={props.handleClickWindowClose}></div>
        <div id="megaMenu4" className="container-fluid MegaMenu MegaMenu-top-one">
          <h1>Технологии</h1>
        </div>
        </>
      );
...
export default withRouter(Navbar_Sections);