...
class Weddings_celebrations extends React.Component {
  static route = '/prints/:name';
  pageQuery = gql`
  query page{
    page(url: "/weddings_celebrations/${this.props.router.query.name}"){
      id
      name
      text
      sectionID
...
export default withRouter(Weddings_celebrations)
